...
internal class ByteBankAtendimento
{
    private List<ContaCorrente> _listaDeContas = new List<ContaCorrente>() {
        new ContaCorrente(95){Saldo=100,Titular = new Cliente{Cpf="11111", Nome="Henrique",Profissao="Desenvolvedor de Software"}},
        new ContaCorrente(95){Saldo=200,Titular = new Cliente{Cpf="22222", Nome="Pedro",Profissao="UX Designer"}},
        new ContaCorrente(94){Saldo=60,Titular = new Cliente{Cpf="33333", Nome="Marisa",Profissao="Analista de produtos"}}
    };
    ...
    {
        #region Outra forma de fazer o filtro na lista
